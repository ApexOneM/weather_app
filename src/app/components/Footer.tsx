...
const Footer = () => {
    return (
        <footer className="md:col-span-4 col-span-1 col-start-1 md:row-span-1 row-span-2 md:row-start-11 row-start-24 flex md:justify-between justify-center items-center md:px-8 md:flex-row flex-col-reverse md:gap-0 gap-1 md:mt-0">
